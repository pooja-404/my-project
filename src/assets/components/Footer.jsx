        ...
        <div>
            <footer className="footer-img">
                <div className="container pt-5">
                    <p className="ff-poppins fw-semibold fs-xl text-center lh-124 color-white  pt-80 m mb-0">JOIN US</p>
                    <div className="row pt-4">
                        <div className="col-lg-7 col-12 pt-5 ">
                            <p className="ff-poppins  fw-medium fs-2lg lh-124 color-white pt-5 cursor-pointer">LOGO</p>
                            <p className="ff-poppins fw-normal lh-150 color-white fs-xs op-6 max-w-380">Aenean arcu sed rhoncus sapien euismod cursus morbi lacus, blandit.
                                Placerat
                                tortor
                        ...
                        <div className="col-lg-5 col-12 pt-5">
                            <div className="row pt-lg-5 ">
                                <div className=" col-6 pt-sm-0 ">
                                    <p className="ff-poppins fw-medium lh-150 color-white fs-xs pt-lg-5 mb-0 pb-2">Resources</p>
                                    <ul className='ps-0'>
                                        <li><a href="" className="ff-poppins fw-normal fs-xxs lh-136 color-white line-links  ">Roadmap</a></li>
                                        <li><a href="" className="ff-poppins fw-normal fs-xxs lh-136 color-white line-links ">FAQs</a></li>
                                        <li><a href="" className="ff-poppins fw-normal fs-xxs lh-136 color-white line-links ">Mint your Bully</a></li>
                                    </ul>
                                </div>
                                <div className=" col-6 pt-sm-0 ">
                                    <p className="ff-poppins fw-medium lh-150 color-white fs-xs pt-lg-5 mb-0 pb-2">Community</p>
                    ...
                    <p className="ff-poppins fw-normal lh-150 color-white fs-xs  max-w-347 pb-3 mb-0 cursor-pointer">Email@gmail.com</p>
                </div>
            </footer >
